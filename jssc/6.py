...
while True:
    url = 'https://1680250.com/api/expertsRecommend/list.do?lotCode=10037&groupCode=1&ranking=6&type=0&field=winningProbability&sort=desc'
    ...
    cursor = db.cursor()
    cursor.execute("insert into jisusaijihua(rank,qihao,haoma)values(%s,%s,%s)", (6, qihao[0], hapma_list[0]))
    db.commit()
    time.sleep(second)