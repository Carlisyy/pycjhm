...
url='https://1680250.com/api/pks/getPksDoubleCount.do?date=&lotCode=10035'
...
cursor = db.cursor()
cursor.execute("insert into kaijiang(caizhong,qishu,kaihaoma)values(%s,%s,%s)", ('jsft', qishu, hapma_list))
db.commit()